...
$catagory2="Music";
$catagory3="Podcasts";
$sql="SELECT * FROM unlockedaccounts WHERE userid=? AND catagory=? OR userid=? AND catagory=? OR userid=? AND catagory=?;";
...
mysqli_stmt_bind_param($stmt,"ssssss",$userid,$catagory,$userid,$catagory2,$userid,$catagory3);
...
$catagory="Videos";
$catagory2="Music";
$sql5="SELECT * FROM unlockedaccounts WHERE userid=? AND catagory=? OR userid=? AND catagory=? OR userid=? AND catagory=?;";
$stmt=mysqli_stmt_init($conn);
...
$sql9="SELECT * FROM featuredaccounts WHERE (catagory='$catagory') OR (catagory='$catagory2') OR (catagory='$catagory3');";
    ...
    <div id="preloader"></div>
        ...
        <nav class="flex-div">
            ...
            <div class="nav-middle flex-div" >
                ...
                <input type="text" class="search" placeholder="Search Videos" id="search_query">
                <input type="text" class="search1" placeholder="Search Videos" id="search_query1">
            ...
            <div class="nav-right flex-div">
                ...
                <?php
                        if(isset($_SESSION['username']))
                        {
                            ...
                            <li><a  href='includes/theme.inc.php?t=dark&l=videos'><i id='dark' class='fas fa-moon'></i>Dark Theme</a></li>
                             <br>
                             <li><a  href='includes/theme.inc.php?t=light&l=videos'><i id='light' class='fas fa-sun'></i>Light Theme</a></li>
                             <br>
        ...
        <div class="sidebar">
            <ul>
                ...
                <li><a href="#" id="selected"><i class="fas fa-video"></i>Videos</a></li>
        ...
        <div class="accountscontainer">
            ...
            while($row9=mysqli_fetch_assoc($result9)){
                ...
                $sql10="SELECT * FROM unlockedaccounts WHERE useremail='$useremail';";
                $result10=mysqli_query($conn,$sql10);
                $row10=mysqli_fetch_assoc($result10);
                $rownum10=mysqli_num_rows($result10);
                if($row9["accountname"] != $row10["accountname"]){
                echo '
                <div class="a">
                <div class="aaa">
                ...
                ';
                    ...
                    <div class="a">
                    <div class="aaa">
                    <a href="account.php?ID='.$row9["accountid"].'"><img class="ipaccount" src="profilepictures/'.$row9["profileimage"].'" title="'.$row9["accountname"].'"></a>
                    </div>
                    </div>
                    ';
                }
...

        {
                ...
                $rownum3=mysqli_num_rows($result4);
                    ...
                    if($rownum3>0)
                    {
                        while( $row4=mysqli_fetch_assoc($result4))
                        {
                            ...
                            <input type="image" src="content/videos/thumbnails/'.$row8["directoryname"].'/'.$row4["thumbnail"].'" class="thumbnail" name="thumbnail">
                            </form>
                            <p class="videodescription">'.$row4["videotitle"].'
                            </p>
                            <div class="videodetails flex-div">
                                <img src="profilepictures/'.$row5["profileimage"].'" class="accounticon">
                                <div class="videoinfo">
                                <div class="verify">
                                <p class="videoviews" id="time"> <a href="account.php?ID='.$row8["id"].'">'.$row4["uploader"].'<img src="images/check.png" alt=""></p></a>
                                </div>
            ...
            echo "
            <div class='secondbanner'>
            <h1>You have no unlocked accounts for videos therefore there's no content to watch.Please unlock an account.Thank you.
            </h1>
            </div>";
        }
        ...
        <div class="second-nav">
         ...
         <li>
            <div class="di">
                <a href="#"><i id="chosen" class="fas fa-video"></i></a>
                <p id="chosen">Videos</p>
            </div>
        </li>
