    ...
    <div id="preloader"></div>
        ...
        <nav class="flex-div">
            ...
            <div class="nav-middle flex-div" >
                ...
                <input type="text" class="search" placeholder="Search Series" id="search_query">
            ...
            <div class="nav-right flex-div">
                ...
                <?php
                        if(isset($_SESSION['username']))
                        {
                            ...
                            <li><a href='uploadmusic.php'><i class='bi bi-file-music-fill'></i></a></li>
                            </ul>
        ...
        <div class="sidebar">
            <ul>
                ...
                <li><a href="series.php" id="selected"><i class="fas fa-clapperboard"></i>Series</a></li>
                ...
                <li><a href="accountstogift.php"><i class="bi bi-balloon-heart-fill"></i>Gift Your Loved One</a></li>
                    ...
                    if($rownum3>0)
                    {
                        while( $row4=mysqli_fetch_assoc($result4))
                        {
                            ...
                            <div class="videodetails flex-div">
                                ...
                                <div class="videoinfo">
                                    <p class="videoviews" id="time">'.$row4["views"].' views | '.$currenttime.'</p>
                                </div>
                            </div>
                        </div>
                            ';
