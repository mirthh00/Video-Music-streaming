...
$sql5="SELECT * FROM unlockedaccounts WHERE (userid='$userid' AND catagory='$catagory') OR (userid='$userid' AND catagory='$catagory1') OR (userid='$userid' AND catagory='$catagory2');";
$data1=mysqli_query($conn,$sql5);
