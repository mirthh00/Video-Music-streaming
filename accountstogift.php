    ...
    <div id="preloader"></div>
        ...
        <div class="sidebar">
            <ul>
                ...
                <li><a href="accountstogift.php" id="selected"><i class="bi bi-balloon-heart-fill"></i>Gift Your Loved One</a></li>
        ...
        if($rownum>0)
        {
            while($row=mysqli_fetch_assoc($data)){
                ...
                $sql12="SELECT * FROM unlockedaccounts WHERE  accountname=?;";
                $stmt=mysqli_stmt_init($conn);
                ...
                if($rownum12==0){
                    echo '
                <a href="gift.php?ID='.$row["id"].'"><img class="ipaccount" src="profilepictures/'.$row["profileimage"].'"></a>
                ';
                }
                else{
                    echo '
