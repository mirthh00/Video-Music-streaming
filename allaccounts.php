...
$sql="SELECT * FROM intellipreneurs;";
...
<html>
    ...
    <title>All Accounts</title>
        ...
        <script defer src="https://kit.fontawesome.com/a25a382205.js" crossorigin="anonymous"></script>
    ...
    <div id="preloader"></div>
            ...
            <div class="nav-right flex-div">
                ...
                <?php
                        if(isset($_SESSION['username']))
                        {
                            ...
                            <li><a  href='includes/theme.inc.php?t=dark&l=allaccounts'><i id='dark' class='fas fa-moon'></i>Dark Theme</a></li>
                             <br>
                             <li><a  href='includes/theme.inc.php?t=light&l=allaccounts'><i id='light' class='fas fa-sun'></i>Light Theme</a></li>
                             <br>
        ...
        <div class="sidebar">
            ...
            <li><a href="home.php" ><i class="fas fa-film"></i>Series</a></li>
                ...
                <li><a href="#" id="selected"><i class="fas fa-user-check"></i>All Channels</a></li>
        ...
        if($rownum>0)
        {
            while($row=mysqli_fetch_assoc($data)){
                ...
                $sql12="SELECT * FROM unlockedaccounts WHERE userid=? AND  accountname=?;";
                $stmt=mysqli_stmt_init($conn);
                ...
                $rownum13=currencyFormat($rownum13);
                ...
                if($rownum12>0){
                    ...
                    if($star5>$star4 && $star5>$star3 && $star5>$star2 && $star5>$star1){
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> </p>';
                    }

                    elseif($star4>$star5 && $star4>$star3 && $star4>$star2 && $star4>$star1){
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> </p>';
                    }

                    elseif($star3>$star5 && $star3>$star4 && $star3>$star2 && $star3>$star1){
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> </p>';
                    }

                    elseif($star2>$star5 && $star2>$star4 && $star2>$star3 && $star2>$star1){
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> </p>';
                    }

                    elseif($star1>$star5 && $star1>$star4 && $star1>$star3 && $star1>$star2){
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; <i class="fa-solid fa-star"></i> </p>';
                    }
                    else{
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; equal rating </p>';
                    }

                }
                else{
                    echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; no rating yet </p>';
                }
                    
                    echo'
                    <div class="unlockbtn">
                    <a href="account.php?ID='.$row["id"].'"><button>Open</button></a>
                ...
                ';
                    ...
                    if($rownum14>0){
                    if($star5>$star4 && $star5>$star3 && $star5>$star2 && $star5>$star1){
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; '.$rownum13.' Unlockers &bullet; <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i></p>';
                    }

                    elseif($star4>$star5 && $star4>$star3 && $star4>$star2 && $star4>$star1){
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; '.$rownum13.' Unlockers &bullet; <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i></p>';
                    }

                    elseif($star3>$star5 && $star3>$star4 && $star3>$star2 && $star3>$star1){
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; '.$rownum13.' Unlockers &bullet; <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i></p>';
                    }

                    elseif($star2>$star5 && $star2>$star4 && $star2>$star3 && $star2>$star1){
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; '.$rownum13.' Unlockers &bullet; <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i></p>';
                    }

                    elseif($star1>$star5 && $star1>$star4 && $star1>$star3 && $star1>$star2){
                        echo '<p class="chat">'.$row["genre"].' '.$row["catagory"].' &bullet; '.$rownum13.' Unlockers &bullet; <i class="fa-solid fa-star"></i></p>';
                    }
                    else{
                        echo '<p class="chat">'.$row["genre"].'  '.$row["catagory"].' &bullet; '.$rownum13.' Unlockers &bullet; equal rating</p>';
                    }

                }
                else{
                    echo '<p class="chat">'.$row["genre"].'  '.$row["catagory"].' &bullet; '.$rownum13.' Unlockers &bullet; no rating yet</p>';
                }
                    
                    echo'
                    <div class="unlockbtn">
                    <a href="subscribe.php?ID='.$row["id"].'"><button><i class="fa-solid fa-lock-open"></i> Unlock</button></a>
                    </div>
                    <br>
                    </div>
                ';
