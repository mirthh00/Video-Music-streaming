...
$sql4="SELECT * FROM musicstats WHERE country=? ORDER BY streams DESC LIMIT 30;";
$stmt=mysqli_stmt_init($conn);
...
<body class="<?php echo "$color";?>">
    ...
    <div class="containbanner">   
        <div class="thirdbanner">
            <h1>Trending In Music</h1>
        </div>
        <h1 id="boardtitle">Songs</h1>
        ...
        <div class="board">
            ...
            <div class="contentcontainer">
                <?php
                    ...
                    while($row4=mysqli_fetch_assoc($result5)){
                        ...
                        $sql5="SELECT * FROM music WHERE song=?;";
                        $stmt=mysqli_stmt_init($conn);
                    ...
                    <input type="image" src="music/covers/<?php echo "$songid"; ?>.jpg" class="thumbnail">  
                </form>
                    ...
                    <div class="videodetails flex-div">
                        ...
                        <div class="videoinfo">
                        <div class="verify">
                                <p class="videoviews" id="time"> <a href="account.php?ID=<?php echo $row8["id"]; ?>"><?php echo "$uploader"; ?><img src="images/check.png" alt=""></p></a>
                            </div>
                            <p class="videoviews" id="time"><?php echo "$streams"; ?> views | <?php echo "$uploadedtime"; ?></p>
                        </div>
                    </div>
                </div>
                <?php 
            ...
            <?php
                ...
                ?>
                <h1 id="boardtitle">Music Videos</h1>
                <div class="contentcontainer">
                    <?php
                        if($rownum6>0) {
