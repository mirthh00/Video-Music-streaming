...
<?php
    ...
    $sql13="SELECT * FROM intellipreneurs WHERE id=?;";
    ...
    $accountname=$row13["accountname"];
    $price=$row13["price"];
    $catagory=$row13["catagory"];
    $profilename=$row13["profileimage"];

    $sql13="SELECT * FROM rooms WHERE roomname=?;";
    $stmt=mysqli_stmt_init($conn);
    ...
    $roomid=$row13["roomid"];
    $roomname=$row13["roomname"];

    include 'includes/dbh.inc.php';
    $sql13="SELECT * FROM users WHERE usersUid=?;";
    $stmt=mysqli_stmt_init($conn);
    ...
    $recommender=$row13["recommended"];
    
    
    $username=$row13["usersUid"];
    $userfullname=$row13["usersName"];
    $useremail=$row13["usersEmail"];
    $userid=$row13["id"];
    $country=$row13["usersCountry"];
