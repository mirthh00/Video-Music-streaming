...
// Construct variables
$cartTotal = '500.00'; // This amount needs to be sourced from your application
$passphrase = 'jt7NOE43FZPn';
$data = array(
    // Merchant details
    'merchant_id' => '10000100',
    'merchant_key' => '46f0cd694581a',
    'return_url' => 'https://42e1-41-13-2-166.eu.ngrok.io/Mirth/advertiseauthenticate.php?a='.$accountid.'',
...
$htmlForm .= '<div class="paybtn"><button name="pay" id="paymentbutton">PAY R500</button></div></form>';
...
<html>
    <head>
        <title>Advertise <?php echo $row["accountname"]; ?></title>
    ...
    <body class="<?php echo "$color";?>">
        ...
        <div class="navigation">
            <ul>
                ...
                ?>
                <li id="home"><a href="#">Advertise</a></li>
        ...
        <div class="subscribe">
            ...
            if(isset($_GET["s"])){
                echo
                    ...
                    <p id="searchfail">Your account has been successfully added to featured series accounts!
                    </p>  
                </div>';
                ...
                <div class="subaccount">
                    <p id="searchfail">Add your account to featured accounts in order to reach
                       potential unlockers!
                    </p>  
                </div>
