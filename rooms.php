...
$sql="SELECT * FROM unlockedrooms WHERE unlockeremail=?;";
    ...
    <div id="preloader"></div>
        ...
        <nav class="flex-div">
            ...
            <div class="nav-middle flex-div" >
                ...
                <input type="text" class="search" placeholder="Search Rooms" id="search_query">
            ...
            <div class="nav-right flex-div">
                ...
                <?php
                        if(isset($_SESSION['username']))
                        {
                            ...
                            <li class='nav-right-icn' title='Change Theme'> <i class='fas fa-moon' id='theme-icon'></i></li>
                            ...
                            <li><a  href='includes/theme.inc.php?t=dark&l=rooms'><i id='dark' class='fas fa-moon'></i>Dark Theme</a></li>
                             <br>
                             <li><a  href='includes/theme.inc.php?t=light&l=rooms'><i id='light' class='fas fa-sun'></i>Light Theme</a></li>
                             <br>
        ...
        <div class="sidebar">
            ...
            <li><a href="home.php" ><i class="fas fa-film"></i>Series</a></li>
                ...
                <li><a href="#" id="selected"><i class="fas fa-comments"></i>Cribs</a></li>
        ...
        if($rownum>0)
        {
            ...
            echo '
            <div class="secondbanner">
            <h1>You have no unlocked cribs.Please unlock a channel with a crib in all channels page.Thank you.
            </h1>
            </div>
            ';
        }
        ...
        <li>
            <div class="di">
                <a href="#"><i id="chosen" class="fas fa-comments"></i></a>
                <p id="chosen">Cribs</p>
            </div>
        </li>
