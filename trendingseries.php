...
<body class="<?php echo "$color";?>">
    ...
    <nav>
        ...
        <div class="thirdbanner">
            <h1>Trending In Series</h1>
        </div>
        <h1 id="boardtitle">Series</h1>
        </div>
        <div class="cd">
        <div class="board">
            ...
            <div class="contentcontainer">
                <?php
                    ...
                    <div class="video">
                    <input type="image" src="content/videos/thumbnails/<?php echo "$directoryname"; ?>/<?php echo "$thumbnail"; ?>" class="thumbnail" name="thumbnail" title="Watch <?php echo "$title"; ?>">
                    </form>
